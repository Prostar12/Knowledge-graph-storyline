...
def main_for_evaluation():
    ...
    wordembedding = np.load('./data1/vec.npy')
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            for model_iter in testlist:
                ...
                test_y = np.load('./data1/testall_y.npy')
                test_word = np.load('./data1/testall_word.npy')
                test_pos1 = np.load('./data1/testall_pos1.npy')
                test_pos2 = np.load('./data1/testall_pos2.npy')
                allprob = []
                acc = []
                ...
                allans = np.load('./data1/allans.npy')
...
def main(_):
    ...
    pathname = "./model/ATT_GRU_model-100"
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            f.close()
            f = open('E:\\re data3.txt','r',encoding='utf-8')           
            fw = open('E:\\final re1.txt','w',encoding='utf-8')
            ...
            while True:
                #try:
                    ...
                    if line == '':
                        break
                    print(line)
                    news, time, en1, en2, sentence = line.strip().split()
                    #print("实体1: " + en1)
                    #print("实体2: " + en2)
                    #print(sentence)
                    relation = 0
                    ...
                    for n, rel_id in enumerate(top3_id):
                        if n== 0:
                            fw.write(news+' '+time+' '+en1+' '+en2+' '+id2relation[rel_id]+'\n')
